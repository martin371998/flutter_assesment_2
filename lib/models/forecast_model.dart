...
class Forecastday {
  ...
  num? get getDateEpoch => dateEpoch;
  Day get getDay => day;
  Astro get getAstro => astro;
  List<Hour> get getHour => hour;
...
class Day {
  ...
  late final num? mnumempC;
  late final num? mnumempF;
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['mnumemp_c'] = mnumempC;
    _data['mnumemp_f'] = mnumempF;
...
class Hour {
  ...
  late final num? dewponumC;
  late final num? dewponumF;
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['dewponum_c'] = dewponumC;
    _data['dewponum_f'] = dewponumF;
